...
export const MOONS = Object.freeze([
  ...
  { id: 'sg', name: 'SG-Moon', emoji: '🦁', c: 'c-gold', modelled: 'SMC', long: 'the Singapore Math Challenge (SIMCC)', years: [1, 6], seconds: 170,
    blurb: 'the Singapore syllabus with its heuristics: bar models, before-and-after, guess and check', shape: '2 multiple choice (four options) + 8 short answer, climbing from 2 to 4 marks · almost all typed numbers and brisker, as the real paper is', open: true, heat: sgHeat, topics: SG_TOPICS },
  { id: 't', name: 'T-Moon', emoji: '🏮', c: 'c-violet', modelled: 'WMI', long: 'the World Mathematics Invitational (Taiwan)', years: [1, 6], seconds: 190,
    blurb: 'a logic half and an applications half, all multiple choice', shape: 'Section A logical reasoning ×5 (three 6-mark, two 8-mark) + Section B applications ×5 (10 marks) · all multiple choice, four options', open: true, heat: tHeat, topics: T_TOPICS },
  ...
  { id: 'phi', name: 'PHI-Moon', emoji: '🌴', c: 'c-cyan', modelled: 'PhIMO', long: 'the Philippine International Mathematical Olympiad (Math Olympiads Training League)', years: [1, 6], seconds: 200,
    blurb: 'the Philippine strands: number sense, geometry, patterns and algebra, measurement, statistics and probability', shape: '5 multiple choice (five options with “None of the above”, 2 marks, one a strand) then three 3-mark and two 5-mark typed answers across the strands · the easy-to-hard ramp of the real paper', open: true, heat: phiHeat, topics: PHI_TOPICS },
