...
// followed the same day. A visit is a ten-question heat, ~3 minutes a question (SMC brisker), and the child's year from sign-up
// picks the band. AMO has no Year 1 paper, so US-Moon opens at Year 2.
...
export const MOONS = Object.freeze([
  ...
  { id: 'hk', name: 'HK-Moon', emoji: '🐉', c: 'c-mint', modelled: 'HKIMO', long: 'the Hong Kong International Mathematical Olympiad (Olympiad Champion Education Centre)', years: [1, 6], seconds: 210,
    blurb: 'number theory and counting above all: factors, unit digits, remainders, permutations', shape: 'all short answer · two from each of Logical thinking, Arithmetic, Number theory, Geometry, Combinatorics', open: true, heat: hkHeat, topics: HK_TOPICS },
  { id: 'bkk', name: 'BKK-Moon', emoji: '🐘', c: 'c-gold', modelled: 'TIMO', long: 'the Thailand International Mathematical Olympiad (Olympiad Champion Education Centre)', years: [1, 6], seconds: 210,
    blurb: 'logic set-pieces and arithmetic tricks: chicken and rabbit, periodic beads, 25 × 32 × 125', shape: 'all short answer · two from each of the same five categories as HK-Moon', open: true, heat: bkkHeat, topics: BKK_TOPICS },
  { id: 'phi', name: 'PHI-Moon', emoji: '🌴', c: 'c-cyan', modelled: 'PhIMO', long: 'the Philippine International Mathematical Olympiad (Math Olympiads Training League)', years: [1, 6], seconds: 200,
    blurb: 'the Philippine strands: number sense, geometry, patterns and algebra, measurement, statistics and probability', shape: '5 multiple choice then 5 short answer, one of each from every strand · the easy-to-hard ramp of the real paper', open: true, heat: phiHeat, topics: PHI_TOPICS },
]);
