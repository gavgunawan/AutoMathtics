...
export { PHASES };
export const build = (shape, year) => ocecBuild(shape, year, 'hk');
export const TOPICS = [
  { band: 'Grades 1–2', lines: ['logical thinking: balance puzzles, figure patterns, work and rest, cryptarithms, what number am I, magic squares, days of the week', 'arithmetic: smart addition, a missing digit, number bonds, doubling and halving, counting in steps', 'number theory and geometry: odd and even, number clues, sums of digits, shapes, counting squares and triangles, matchsticks, halves and quarters', 'combinatorics: two-digit numbers from given digits, handshakes, lining up, paying with coins, colouring flags, choosing two'] },
