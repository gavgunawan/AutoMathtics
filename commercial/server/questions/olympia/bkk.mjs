...
export const TOPICS = [
  { band: 'Grades 1–2', lines: ['logical thinking: balance puzzles, rows of dots, work and rest, sequences with a changing step, shape patterns, days of the week', 'arithmetic: smart addition that pairs to tens, a missing digit, number bonds, doubling and halving, counting in steps', 'number theory and geometry: odd and even, number clues, digits, shapes, counting squares and triangles, matchsticks, the distance round a shape', 'combinatorics: two-digit numbers from given digits, handshakes, lining up, paying with coins, colouring flags'] },
