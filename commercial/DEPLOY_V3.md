...
- Upgrade Authentication to Identity Platform. Enable Email/Password and, under
  ...
  then 30 seconds, 45 seconds, 5 minutes, 15 minutes, 1 hour, 6 hours and 12 hours
...
after the first code and 45 seconds after the second (5 seconds each from 13 Sep 2026 until 17 Sep, when the logs showed a
parent spend a whole run in 37 seconds, meet the wall and never come back), then
5 minutes, 15 minutes, 1 hour, 6 hours, 12 hours, and a day before the ninth; a day without a code to
