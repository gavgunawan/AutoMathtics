...
export function fixture() {
  ...
  return { service, learning, game, billing, payments, support, recovery, email, resetPassword, enrollPhone, gateway, store, identity, users, tokens, auth, token, login, family, child, childSession, now: () => clock, advance: (ms) => { clock += ms; } };
}
