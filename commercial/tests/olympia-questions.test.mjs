...
test('every heat is ten questions in the moon\'s real shape: SEAMO four 3-mark and four 4-mark MC then two 6-mark SA, five options with "None of the above" on every paper; AMO six 3-mark MC of five then two 5-mark and two 6-mark SA; SMC 2 MC of four + 8 SA; WMI five logic then five applications, all MC; AMC 8 ten MC of five options in three climbing bands', () => {
